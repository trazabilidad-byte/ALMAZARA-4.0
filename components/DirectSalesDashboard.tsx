                      ...
                      {buyer ? (
                        <button onClick={() => onViewCustomer(buyer)} className="bg-[#efffc2] px-3 py-2 rounded-xl border border-[#D9FF66] text-left hover:bg-[#D9FF66] transition-colors group/buyer">
                          ...
                          <div className="flex items-center gap-1.5 mt-0.5 text-black/60 group-hover/buyer:text-black">
                            <User size={10} />
                            <span className="text-[9px] font-bold uppercase">{String(buyer.cif || buyer.id)}</span>
                          </div>
                        </button>
                      ) : (
                        sale.comprador_name ? (
                          <div className="bg-gray-50 px-3 py-2 rounded-xl border border-gray-200 text-left">
                            <p className="text-xs font-black text-gray-800 uppercase">{sale.comprador_name}</p>
                            <p className="text-[9px] font-bold text-gray-400 uppercase italic">Registro Sincronizado</p>
                          </div>
